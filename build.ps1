...
md build -Force
cmake -S consumer -B build -DCMAKE_BUILD_TYPE=Release -DBoost_ROOT="D:\dev\fusion\3P\BOOST\1.1850.1\win64_0002" -DPACT_FFI_ROOT="D:\dev\pact_ffi-v0.5.0" -DPactUseConan=OFF -DPactBuildTests=OFF -DBUILD_SHARED_LIBS=OFF
